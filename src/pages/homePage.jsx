                ...
                <div className='h-full pt-32 flex flex-col-reverse lg:flex-row max-w-7xl mx-auto p-4 pb-20 lg:pb-0'>
                    <div className='w-full lg:w-1/2 pt-10 lg:pt-24'>
                        <div className='text-white text-center lg:text-left'>
                            <h1 className='text-xl md:text-3xl lg:text-4xl font-extralight mb-4'>From the looms of<br/></h1>
                            <h1 className='text-6xl md:text-8xl lg:text-9xl text-animated-bg font-bold'>SWAZZEL</h1>
                            ...
                            <div className='mt-10'>
                                <a href="https://swatisahay.com" target="_blank" rel="noreferrer" className="px-10 pb-3 pt-4 border text-xl hover:bg-white hover:bg-opacity-10 duration-200">Visit Store</a>
                            </div>
                        </div>
                    </div>
                    <div className='w-full lg:w-1/2'>
                        <img src={`${process.env.PUBLIC_URL}/images/hero.png`} className="w-2/3 md:w-1/2 lg:w-full mx-auto select-none" alt="woman in black derss" />
                    </div>
                </div>
            </div>

            <div className='bg-black/90'>
                <div className="m-scroll relative h-14 overflow-hidden">
                    <div className="m-scroll__title py-2 border-t border-b border-white/50 flex items-center justify-start whitespace-nowrap absolute top-0 left-0">
                        <div className='flex scroll-text text-white/40 gap-32'>
                            {
                                ['Fashion','Trend','Style','Latest', 'buzz', 'craze', 'wardrobe', 'glow','collection', 'winter', 'summer', 'classic', 'bold', 'elegant', 'forward', 'glam', 'costume', 'Fabric', 'Casual', 'basic'].map((item, index) => {
                                    return(
                                        <div className='text-lg font-extrabold uppercase tracking-widest pt-2' key={index}>{item}</div>
                                    )
                                })
                            }
                        </div>
                    ...
                    <div className='max-w-7xl mx-auto p-4'>
                        ...
                        <div className='flex flex-col-reverse md:flex-row gap-14'>
                            <div className='w-full md:w-1/2'>
                                ...
                                <div className='mt-10'>
                                    <a href="https://swatisahay.com" target="_blank" rel="noreferrer" className="px-10 pb-3 pt-4 border text-white text-xl hover:bg-white hover:bg-opacity-10 duration-200">Visit Store</a>
                                </div>
                            </div>
                            <div className='w-full md:w-1/2'>
                                <img src={`${process.env.PUBLIC_URL}/images/swati-sahay.jpeg`} className="w-full" alt="swati sahay website screengrab" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='max-w-7xl mx-auto py-10 md:py-16 px-4'>
                    ...
                    <div className='flex flex-col-reverse md:flex-row gap-14'>
                        <div className='w-full md:w-1/2'>
                            ...
                            <div className='mt-10'>
                                <a href="https://chicankari.com" target="_blank" rel="noreferrer" className="px-10 pb-3 pt-4 font-bold border border-black text-xl hover:bg-white hover:bg-opacity-10 duration-200">Visit Store</a>
                            </div>
                        </div>
                        <div className='w-full md:w-1/2'>
                            <img src={`${process.env.PUBLIC_URL}/images/chicankari.jpeg`} className="w-full" alt="chicankari website screengrab" />
                        </div>
                    </div>
                </div>
            </div>
